...
namespace GameObjectExtenders {
    [NodeType(
        Id = nameof(GetGameObjectPropertyNode), // Must be unique. Generate one at https://guidgenerator.com/
        Title = " Get GameObject Property",
        Category ="Fnugus")]
    public class GetGameObjectPropertyNode : Node {
        [DataInput]
